 ...
 * @author roland
 */
public class RestGet extends AbstractRestFunction<RestGet> {
     ...
     * @param httpClient
     */
    public RestGet(String url, Map<String, String> headers, DefaultHttpClient httpClient) {
     ...
     * @return
     */
    public RestGet setParameter(String key, String value) {
